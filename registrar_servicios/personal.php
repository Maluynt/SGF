    ...
    <section class="asideleft">
        ...
        <section class="article">
            <article>
                ...
                include ("../../conexion/conexion_bd.php");
                include ("ingresar_personal.php");

                ?>
                <form method="post" action="ingresar_personal.php"> <!-- Formulario para enviar datos -->
                    <div class="caja">
                        <div class="grupo">
                            <h3 class="etiqueta">Personal</h3>

                            <label for="N_Carnet">Nº Carnet:</label>
                            <input type="text" class="input" id="N-Carnet" name="N-Carnet" required> <!-- Campo de entrada para personal -->

                            <label for="nombre">Nombre:</label>
                            <input type="text" class="input" id="nombre" name="nombre" required> <!-- Campo de entrada para personal -->

                            <label for="apellido">Apellido:</label>
                            <input type="text" class="input" id="apellido" name="apellido" required> <!-- Campo de entrada para personal -->
                            ...
                            <select name="responsabilidad" id="responsabilidad">
                                ...
                                <option value="Operativo_CCF">Operativo_CCF</option>
                                <option value="Tecnico">Tecnico</option>
                            </select> <!-- Campo de entrada para código de personal -->
                        </div>
                        <br>
                        <div class="botones">
                            ...
                            <a href="../inicio/inicio.php" class="segundo">REGRESAR</a>
                        </div>
