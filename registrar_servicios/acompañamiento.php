    ...
    <section class="asideleft">
        ...
        <section class="article">
            <article>
                ...
                include("../../conexion/conexion_bd.php");
                include("ingresar_acompañamiento.php");

                ?>
                <form method="post" action="ingresar_acompañamiento.php"> <!-- Formulario para enviar datos -->
                    <div class="caja">
                        <div class="grupo">
                            <h3 class="etiqueta">Acompañamiento</h3>
                            <label for="acompañamiento">Nombre:</label>
                            <input type="text" class="input" id="acompañamiento" name="acompañamiento" required> <!-- Campo de entrada para acompañamiento -->
                        </div>
                        <br>
                        <div class="botones">
