...
<?php endif; ?>
                ...
                <form method="POST" action="/metro/SGF/estadistica/controlador/controlador_editar.php" class="needs-validation" novalidate>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="mt-4 d-flex justify-content-between">
                            ...
                            <a href="/metro/SGF/estadistica/controlador/controlador_consulta.php"
...
<script>
  function incrementarIntervencion(idFalla) {
    fetch('/metro/SGF/estadistica/controlador/controlador_editar.php', {
        method: 'POST',
        headers: {
