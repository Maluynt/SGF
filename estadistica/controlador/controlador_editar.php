...
class ControladorEditar {
    ...
    private function redirigirSegunPerfil(): void {
        ...
        $rutas = [
            ...
            'Inspector' => '/metro/SGF/inicio/controlador/controlador_inicio.php',
            'Controlador' => '/metro/SGF/inicio/controlador/controlador_inicio.php',
    ...
    private function cargarVista(string $vista, array $datos): void {
        $ruta = $_SERVER['DOCUMENT_ROOT'] . "/metro/SGF/consulta/vista/{$vista}.php";
    ...
    private function incrementarIntervencion(): void {
        ...
        header("Location: /metro/SGF/consulta/controlador/controlador_editar.php?id=" . $id . "&actualizado=1");
        exit;
    }
...
try {
    ...
    header("Location: /metro/SGF/consulta/controlador/controlador_consulta.php?error=" . urlencode($e->getMessage()));
    exit;
}